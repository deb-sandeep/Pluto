 ...
 */
public class ScripITDSummaryTableModel extends AbstractTableModel
    ...
    public static final Logger logger = Logger.getLogger( ScripITDSummaryTableModel.class ) ;

    /** The cache from which the ITD data is actually fetched for display. */
    private final ScripITDValueCache valueCache ;

    /** Public no argument constructor. */
    public ScripITDSummaryTableModel() {
        this.valueCache = ScripITDValueCache.getInstance() ;
    }
    ...
    public ScripITD getScripITDForRow( final int row ) {
        return this.valueCache.getScripITDForRow( row ) ;
    }
