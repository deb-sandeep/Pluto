 ...
 */
public class ScripEODSummaryTable extends JTable implements DragGestureListener {

    /** Default serial version UID. */
    private static final long serialVersionUID = 1L ;

    /** Log4J logger for this class. */
    public static final Logger logger = Logger.getLogger( ScripEODSummaryTable.class ) ;
    ...
    private final MouseListener mouseListener = new MouseAdapter() {
        ...
        public void mouseClicked( final MouseEvent e ) {
            ...
            if( e.getClickCount() == 2 ) {
                final int row = ScripEODSummaryTable.this.rowAtPoint( e.getPoint() ) ;
                if( row != -1 ) {
                    ...
                    try {
                        ...
                        final ScripEODSummaryTableModel model = ( ScripEODSummaryTableModel )getModel() ;
                        final ScripEOD scripEOD = model.getScripEODForRow( modelRowId ) ;
                        ...
                        cfg = new ChartEntityConfig( scripEOD.getSymbolId(),
                                           EntityType.SCRIP, scripEOD.getDate() ) ;
                        cfgList.add( cfg ) ;
    ...
    public void dragGestureRecognized( final DragGestureEvent dge ) {
        ...
        final ChartEntityConfig cfg = new ChartEntityConfig(
                scripEOD.getSymbolId(), EntityType.SCRIP, scripEOD.getDate() ) ;
